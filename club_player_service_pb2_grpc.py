...
class ClubPlayerServiceGrpcStub(object):
    ...
    def __init__(self, channel):
        ...
        self.UpdatePlayerTags = channel.unary_unary(
                ...
                response_deserializer=club__player__service__pb2.ClubPlayerResponse.FromString,
                _registered_method=True)
        self.RemovePlayersTag = channel.unary_unary(
                '/club_player_service.ClubPlayerServiceGrpc/RemovePlayersTag',
                request_serializer=club__player__service__pb2.RemovePlayersTagRequest.SerializeToString,
                response_deserializer=club__player__service__pb2.RemovePlayersTagResponse.FromString,
                _registered_method=True)
...
class ClubPlayerServiceGrpcServicer(object):
    ...
    def RemovePlayersTag(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_ClubPlayerServiceGrpcServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'RemovePlayersTag': grpc.unary_unary_rpc_method_handler(
                    servicer.RemovePlayersTag,
                    request_deserializer=club__player__service__pb2.RemovePlayersTagRequest.FromString,
                    response_serializer=club__player__service__pb2.RemovePlayersTagResponse.SerializeToString,
            ),
    }
...
class ClubPlayerServiceGrpc(object):
    ...
    def RemovePlayersTag(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/club_player_service.ClubPlayerServiceGrpc/RemovePlayersTag',
            club__player__service__pb2.RemovePlayersTagRequest.SerializeToString,
            club__player__service__pb2.RemovePlayersTagResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
